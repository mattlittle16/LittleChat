  ...
  return (
    <div className="flex h-screen overflow-hidden relative">
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div style={{ position: 'absolute', top: '-15%', right: '-5%', width: '42%', paddingBottom: '36%' }}>
        ...
        <div style={{ position: 'absolute', bottom: '-8%', left: '15%', width: '40%', paddingBottom: '30%' }}>
        ...
        <div style={{ position: 'absolute', top: '-10%', left: '-5%', width: '34%', paddingBottom: '28%' }}>
        ...
        <div style={{ position: 'absolute', top: '28%', right: '-6%', width: '32%', paddingBottom: '26%' }}>
        ...
        <div style={{ position: 'absolute', bottom: '-6%', right: '5%', width: '30%', paddingBottom: '24%' }}>
        ...
        <div style={{ position: 'absolute', top: '42%', left: '-8%', width: '28%', paddingBottom: '24%' }}>
